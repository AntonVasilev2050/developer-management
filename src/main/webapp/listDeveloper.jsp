...
<table border=1>
    ...
    <c:forEach items="${developers}" var="developer">
        <tr>
            ...
            <td><a href="DeveloperController?action=edit&developerId=<c:out value="${developer.id}"/>">Update</a></td>
            <td><a href="DeveloperController?action=delete&developerId=<c:out value="${developer.id}"/>">Delete</a></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
